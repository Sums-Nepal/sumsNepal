      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          {pdfURL && pdfURL.trim().length > 0 && (
            ...
            >
              <div
                className="fixed right-6 top-6 bg-white shadow-lg hover:shadow-2xl transition-shadow duration-300 rounded-full p-2 cursor-pointer z-50 hover:bg-orange-50"
                onClick={() => setPDFURL("")}
              >
